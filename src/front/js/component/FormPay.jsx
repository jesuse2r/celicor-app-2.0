...
const FormPay = (props) => {
  ...
  if (store?.cartItems?.length == 0) {
    return <h2>no tienes elementos en el carrito</h2>;
  }
  return (
      ...
      <div className="m-4  p-4 ">
            ...
            <div key={`cartitems${cartItem.id}`} className="">
              <div className="row mb-4 d-flex justify-content-between align-items-center">
                ...
                <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                  <h5 className="mb-0">
                    {cartItem.licor.price} * {cartItem.quantity}
                  </h5>
                </div>
        ...
        <div className="row mb-4 d-flex justify-content-around align-items-center ">
          ...
          <div className="col-4 bg-light ">
            <span>
              <h5 className="fw-bold border-bottom border-dark">
                Subtotal: 129.97$
              </h5>
            </span>
            <span>
              <h5 className="fw-bold border-bottom border-dark">
                I.V.A (16%): {129.97 * 0.16}$
              </h5>
            </span>

            <span>
              <h5 className="fw-bold border-bottom border-dark">
                Total $: {129.97 + 129.97 * 0.16}$
              </h5>
            </span>
            <span>
              <h5 className="fw-bold border-bottom border-dark">
