                  ...
                  {store.cartItems?.map((cartItem) => {
                    return (
                      ...
                      <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                        ...
                        <img src={cartItem?.product?.category} alt="Salmon orange fabric pouch with match zipper, gray zipper pull, and adjustable hip belt." className="h-full w-full object-cover object-center"/>
                      </div>
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        <div>
                          ...
                          <p className="mt-1 text-sm text-gray-500">{cartItem?.product?.Name}</p>
                        </div>
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <p className="text-gray-500">{cartItem?.product?.quantity}</p>
