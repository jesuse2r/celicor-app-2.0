...
const Navbardos = () => {
    return (
        <>
            <div className="bg-gradient-to-br from-blue-500  via-blue-800 antialiased bg-no-repeat text-white">
                    ...
                    <nav>
                        <ul className="flex items-center justify-center font-semibold">
										...
										group-hover:translate-x-3
										 duration-500 ease-in-out rounded-sm"></div>
                                            <div className="relative z-10">
												...
												bg-clip-text text-transparent
												bg-gradient-to-br from-indigo-400
												font-semibold hover:from-blue-600 hover:to-indigo-600 hover:via-pink-400 py-1 block">Fcebook</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" className="bg-transparent
												bg-clip-text text-transparent
												bg-gradient-to-br from-indigo-400
												font-semibold hover:from-blue-600 hover:to-indigo-600 hover:via-pink-400 py-1 block">Telegram</a>
                                                    </li>
                            ...
                            <li
                                className="relative group px-3 py-2">
                                <button className="hover:opacity-50
								cursor-default text-[20px]">resources</button>
                                <div className="absolute top-0 -left-2 transition">
                                    <div className="absolute top-0 -left-48 transition
								group-hover:translate-y-5 translate-y-0 
								opacity-0 invisible group-hover:opacity-100 
								group-hover:visible duration-500 ease-in-out 
								group-hover:transform z-50 min-w-[300px] 
								transform">
                                        ...
                                        <div className="relative top-6 p-6 bg-white rounded-xl shadow-xl w-full">
											...
											rotate-45 absolute top-0 z-0 
											-translate-x-4 transition-transform 
											group-hover:translate-x-[12.50rem] duration-500 
                                            ...
                                            <div className="relative z-10">
                                                ...
                                                <div className="mt-6 grid grid-cols-2 gap-6">
                                                    <div>
                                                        <p className="uppercase tracking-wider text-gray-500 font-medium text-[13px]">the sunes</p>
                                                        <ul className="mt-3 text-[15px]">
                                                            <li>
                                                                <a href="#" className="text-gray-600 hover:text-gray-800 py-1 block font-normal">get supported caramelos

                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" className="text-gray-600 hover:text-gray-800 py-1 block font-normal"> blog manao

                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" className="text-gray-600 hover:text-gray-800 py-1 block font-normal"> tutorial y mas

                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" className="text-gray-600 hover:text-gray-800 py-1 block font-normal"> friend y amigos

                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" className="text-gray-600 hover:text-gray-800 py-1 block font-normal"> vape and dogs
                            ...
                            <li
								...
								cursor-default text-[20px]">Princing</a>
