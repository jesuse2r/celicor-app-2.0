        ...
        <>
            ...
            <div className="bg-black antialiased bg-no-repeat text-white ">
                <div className="container mx-auto px-4 py-6 flex items-center justify-between">
                    <Link to="/" className="font-bold text-white text-xl md:flex"><img src={logo} className="logo"></img></Link>

                    <nav className="">
                        <ul className="flex items-center justify-center font-semibold md:flex">
                                    ...
                                    <div className="relative top-6 p-6 bg-white rounded-xl shadow-xl w-full">
                                        ...
                                        <div className="relative z-10">
                                            <div className="grid grid-cols-2 gap-6">
                                                <ItemNavbar type="whisky" title="Añejamiento" categories={[{ name: "Premium", url: "premium" }, { name: "Deluxe", url: "deluxe" }, { name: "Standard", url: "standard" }, { name: "SemiStandard", url: "semistandard" }]} />
                    ...
                    <nav>
                        <ul className="flex gap-2 md:flex">
                            {store.token != "" && (
                                <li className="rounded-full px-3 py-2 font-semibold bg-white bg-opacity-10 flex items-center group md:flex">
                                    <button
