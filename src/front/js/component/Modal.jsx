    ...
    <>
      ...
      <div className=''>
        ...
        <div className="relative w-full">
          ...
          <input onClick={() => setShowModal(true)}
            ...
            className="  rounded-full px-3 py-3 font-semibold bg-white bg-opacity-10 flex items-center group  p-4 pl-10 text-sm text-white-900    
                               dark:placeholder-gray-400 dark:text-neutral " placeholder="Buscar licores..." required />
      ...
      {showModal ? (
        <>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-10xl h-full">
              {/*content*/}
                  ...
                  <h3 className="text-3xl font-semibold ">
                    ...
                    <form>
                      ...
                      <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg    dark:placeholder-gray-400 dark:text-white  " placeholder="Busqueda de licores" required />
                        <button type="submit" class="text-black absolute right-2.5 bottom-2.5 bg-neutral-700 hover:bg-neutral-800 focus:ring-4 focus:outline-none focus:ring-neutral-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-neutral-600 dark:hover:bg-neutral-700 dark:focus:ring-neutral-800">Buscar</button>
                      </div>
                    </form>
